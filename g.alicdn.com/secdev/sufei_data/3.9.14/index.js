! function(n, t, r, i, a, e, o, c, u, f, s, l, m, h, v) {
    var p, d = "3.9.12",
        g = "isg",
        y = c,
    ...
    ! function(n) {
        ...
        n.b = e, n.c = o, n.d = a.now || function() {
            return +new a
        }, n.e = c, n.f = f;
        var _ = /^(?:https?:)?\/{2,}([^/?#\\]+)/i,
            k = /[@:]/;
    ...
    var k, x = function() {
            function n(n) {
                this.n = new e("(?:^|; )" + n + "=([^;]+)", "g"), this.o = n + "=", this.p = ""
            }
        ...
        function a(n, t, r) {
            if (!(_.indexOf("XueXi") >= 0)) {
                ...
                var i = e(),
                    ...
                    o = "fourier.taobao.com";
                l.host.indexOf(".aliexpress.") > 0 && (o = "fourier.aliexpress.com"), c(a, "https://".concat(o, "/ts?"))
            }
        }
    ...
    ! function(n) {
        ...
        function r(n) {
            K = n.clientX, Z = n.clientY, $++, nn = e(tn, rn)
        }

        function a(n) {
            N = n.isTrusted;
            var t = n.touches[0];
            K = t.clientX, Z = t.clientY, $++, nn = e(tn, rn)
        }
        ...
        function o(n) {
            if (D = n.isTrusted, b) {
                var r = n.target,
                    ...
                    e = r.offsetHeight >> 1;
                if (!(a < 10 && e < 10)) {
                    var o = i.abs(n.offsetX - a),
                        u = i.abs(n.offsetY - e),
                        f = o < 2 && u < 2;
                    if (f && ln++, ln >= 3 && (3 === ln && (s(t, 2e4), p.i(c, "pagehide", t)), sn && sn.length < 20)) {
                        var l = (f ? "" : "!") + r.tagName;
                        sn.push(l)
                    }
                }
        ...
        function w() {
            var n = h.availWidth,
                t = p.l();
            Y = n - t < 20, an = y.innerWidth, en = y.innerHeight
        }
        ...
        function A() {
            if ("ontouchmove" in u && (p.i(u, "touchmove", v, !0), p.i(u, "touchstart", a, !0)), p.i(u, "mousemove", m, !0), p.i(u, "mousedown", r, !0), p.i(u, "click", o, !0), p.i(u, "keydown", g, !0), p.i(c, "scroll", d, !0), p.i(c, "focus", x), p.i(c, "blur", z), p.i(c, "resize", w), w(), f.getBattery) {
                var n = f.getBattery();
                n && (n.then(function(n) {
                    Q = n
    ...
    ! function(n) {
        ...
        function g() {
            return A && ("complete" !== u.readyState || p.d() - E > 1e4 || j.G() || j.H() || j.I() || j.J()) && (A = !1), A
        }
    ...
    ! function(t) {
        ...
        function a(n, a, e) {
            return function() {
                ...
                return e ? i(n, c) : "apply" in n ? n.apply(this, c) : r(this, n, c)
            }
        }
        ...
        function c(t, r, i) {
            if (!u) return !1;
            var e = u(t, r);
            return !(!e || !e.set) && (e.set = a(e.set, i, !1), b || (e.get = function(n) {
                return function() {
                    return n.call(this)
                }
            }(e.get)), n.defineProperty(t, r, e), !0)
        }
        t.ia = -1;
        var u = n.getOwnPropertyDescriptor;
        t.ja = e, t.ka = o, t.la = c
    }(T || (T = {}));
    var M, B = function() {
        function n(n) {
            this.ma = n;
        ...
        return n.prototype.na = function() {
            for (var n = this.ma, t = [], r = -1, i = 0, a = n.length; i < a; i++)
                for (var e = this[i], o = n[i], c = r += o; t[c] = 255 & e, 0 != --o;) --c, e >>= 8;
            return t
    ...
    ! function(n) {
        ...
        function r(n, t, r, i, a) {
            for (var e = n.length; t < e;) r[i++] = n[t++] ^ 255 & a, a = ~(131 * a)
        }
    ...
    ! function(n) {
        ...
        function v(n) {
            ...
            var i = p.e(n, "?");
            return h(i, y.__sufei_point_list) ? (m(n, 0), !1) : !t(r, E.ha) && (!(r in E.ga) && (!/\/gw-open\/|\/gw\/|ascp\.alibaba\.com/.test(i) && (!h(i, y.__sufei_ignore_list) && (m(n, 0), !1))))
        }

        function d(n) {
            var r = y.__sufei_ignore_list;
            if (!h(l.hostname, r)) {
                var i = u.referrer;
                if (i) {
                    var a = p.g(i);
                    if (a && t(a, E.fa)) return
                }
                m(i, 1)
            }
        }
        ...
        function w() {
            ...
            var r = t[0];
            r || (r = p.j(g)), W.F(r), r = W.sa(!1, !1), i(r), 0 === t.length && d(r), p.i(c, "pagehide", function(n) {
                var t = W.sa(!1, !0);
                z.s(t), p.k(g, t)
            })
        }
    ...
    ! function(n) {
        ...
        function o() {
            f = u.getElementsByTagName("base"), c = t(l), p.i(u, "click", a), p.i(u, "submit", e);
    ...
    ! function(n) {
        ...
        function a() {
            var n = y.jsbridge;
            if (n && (n = n["default"])) return T.ja(n, "pushBack", function(n) {
                "native:" === n[0] && S.ta()
            }), !0
        }
        n.F = t
