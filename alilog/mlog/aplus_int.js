/* @license v8.15.22,8.15.23,1 2024-08-20 20:46:23 */ ! function e(t, n, a) {
    function r(i, s) {
        if (!n[i]) {
            if (!t[i]) {
    ...
    1: [function(e, t, n) {
        ...
        function r(e) {
            var t = window.location.search && window.location.search.length > 0 ? window.location.search.substring(1) : "",
        ...
        function i(e) {
            return u = u || document.getElementsByTagName("head")[0], l && !e ? l : u ? l = u.getElementsByTagName("meta") : []
        }
        ...
        function s(e, t) {
            ...
            if (document.querySelector) {
                ...
                for (var r = i(), s = r.length, u = 0; s > u; u++) {
                    var l = r[u];
                    o(l, "name") === e && (n = o(l, t || "content"))
                }
            return n || ""
        }
        var u, l, c = e("@ali/grey-publish").util;
        n.getArgsQuery = r, n.addScript = function(e, t) {
            var n = e,
                a = /^http(s)?:/;
            n = a.test(e) ? n.replace(a, location.protocol) : location.protocol + (/^\/\//.test(n) ? "" : "//") + n, c.addScript(n, function() {
                "function" == typeof t && t()
            })
        }, n.tryToGetAttribute = o, n.getMetaTags = i, n.getMetaCnt = s, n.indexof = function(e, t) {
        ...
        n.getDateMin = function() {
            var e = new Date,
                t = "";
            return t += e.getFullYear(), t += g(e.getMonth() + 1, 2), t += g(e.getDate(), 2), t += g(e.getHours(), 2), t += g(e.getMinutes(), 2)
        }, n.isMobile = a;
        var p = function() {
            var e;
            try {
        ...
        n.getCurrentNode = p, n.loopAddScript = function(e, t) {
            try {
                if (t && t instanceof Array) {
                    var n = 0,
                        a = function(r) {
                            r && c.addScript(e + "/" + r, function() {
                                a(t[++n])
                            })
                        };
                    a(t[n])
        ...
        var f = function(e, t, n) {
            var a = window,
                ...
                o = e;
            "object" == typeof t && t.message && (o = o + "_" + t.message), n && n.msg && (o += "_" + n.msg), r.push({
        ...
        n.catchException = f, n.getCdnpath = function() {
            var e = "//g.alicdn.com",
            ...
            if (s)
                for (var g = 0; g < l.length; g++) {
                    var v = new RegExp(l[g]);
                    if (v.test(s.src)) {
                        u = l[g], c.test(s.src) && (u = n);
                        break
                    }
                }
            if (u === o) {
            ...
            var e = s("aplus-core") || r("aplusCore"),
                t = window.navigator.userAgent.toLocaleLowerCase(),
                n = /qq\//.test(t),
                a = /micromessenger/.test(t),
                o = /(taobao\.com)|(tmall\.com)/.test(location.hostname),
                i = ["www.taobao.com/", "www.dingtalk.com/"].indexOf(location.hostname + location.pathname) > -1,
                u = /aone\.alibaba-inc\.com/.test(location.hostname),
                l = ["we.taobao.com", "creator.guanghe.taobao.com", "h5.m.goofish.com", "account.yuekeyun.com", "dengta.taopiaopiao.com", "myseller.taobao.com", "dms.alibaba-inc.com", "qn.taobao.com"].indexOf(location.hostname) > -1,
                c = ["aplus.js"].indexOf(e) > -1;
            return (n || a) && o || i || l || u || c
        }
    }, {
        "@ali/grey-publish": 2
    }],
    ...
    3: [function(e, t, n) {
        ...
        function s(e, t) {
            ...
            if (t) {
                ...
                e && e.nonce && r.setAttribute("nonce", e.nonce), r.appendChild(n.createTextNode(t)), a.parentNode.insertBefore(r, a)
            }
        }
        ...
        function c(e, t, n) {
            try {
                if (!d) {
                    ...
                    if (window.addEventListener) return window.addEventListener("storage", a, !1), !1;
        ...
        function p(e, t) {
            h.addScript(t.url, e.callback, function() {
                t.oldCode && (s(e, t.oldCode), h.isFunction(e.callback) && e.callback.call(this, {
                    from: "oldCode"
                }))
            })
        }
        ...
        function f(e, t) {
            var n, a = "cors",
                ...
                o = t.key,
                i = r ? r.split("\n").length : 0;
            i >= t.size && (s(e, r), l(o, e.LS_KEY_CLUSTER, e.LS_PREFIX), _.set(e.LS_KEY_CLUSTER, JSON.stringify([o])), _.set(o, r), n = !0), i < t.size && t.oldCode && (a = "oldCode", s(e, t.oldCode), n = !0), n || p(e, t), c(o, e.LS_KEY_CLUSTER, e.LS_PREFIX), h.isFunction(e.callback) && e.callback.call(this, {
                from: a
            })
        }
        ...
        function v(e, t, n) {
            ...
            if (!t.isDebug && _.test() && (o || r)) {
                var u = g(t),
                    ...
                    v = _.get(l),
                    d = "local";
                v ? (c(l, t.LS_KEY_CLUSTER, t.LS_PREFIX), s(t, v), h.isFunction(i) && i.call(this, {
                    from: d
                })) : h.requestJS(e, navigator.userAgent, function(a) {
                    f(t, {
                        key: l,
                        code: a,
                        oldCode: u,
        ...
        b.load = function(e) {
            ...
            e.ratio >= e.base || s(e) ? (t = e.grey, n.type = "grey", a = e.greySize) : (t = e.stable, n.type = "stable", a = e.stableSize);
            try {
                h.isFunction(e.isLoadDevVersion) && e.isLoadDevVersion() && (t = e.dev, n.type = "dev", a = e.devSize)
            } catch (u) {}
            return n.url = t, h.isFunction(e.before) ? e.before(n, function(t) {
                v(t, e, a)
            }) : v(t, e, a), h.isFunction(e.after) && (e.after = i(e.after, n)), this
        }, b.config = function(e) {
            return o(m, e || {}), this
        }, t.exports = b
    }, {
    ...
    4: [function(e, t, n) {
        ...
        var r = function(e, t, n) {
            ...
            s.type = "text/javascript", s.async = !0, s.src = e, s.onerror = function() {
                a(n) && n()
            }, o ? o.parentNode.insertBefore(s, o) : i && i.appendChild(s), a(t) && t.call(this, {
                from: "script"
            })
        };
        n.addScript = r, n.getCookie = function(e) {
            var t = document,
        ...
        var o = {
            ...
            s = function(e, t, n) {
                ...
                s ? (a = new XMLHttpRequest, a.open(r, e, !0)) : (a = new XDomainRequest, a.open(r, e)), a.timeout = o.timeout, a.onload = i, a.onerror = n, a.ontimeout = n, a.send()
            },
            u = function(e, t, n) {
                window.fetch ? i(e, t, n) : s(e, t, n)
            };
        n.request = u, n.requestJS = function(e, t, n, a) {
            return /blitz/i.test(t) ? void a() : void u(e, n, a)
        }, n.hash = function(e) {
            var t, n, a = 1315423911;
            for (t = e.length - 1; t >= 0; t--) n = e.charCodeAt(t), a ^= (a << 5) + n + (a >> 2);
    ...
    5: [function(e, t, n) {
        ...
        ! function(t) {
            try {
                for (var n, a = t, r = "g_aplus_grey_launched", o = document.getElementsByTagName("script"), i = 0; i < o.length; i++) /mlog\/aplus\.js/.test(o[i].getAttribute("src")) && (n = !0);
                if (n || a[r]) return;
                a[r] = 1;
                var s = e("./for_aplus_fns"),
                    ...
                    f = function() {
                        ...
                        try {
                            ...
                            n && n.length > 0 && a.localStorage.setItem("aplusDebug", n[1]), t = "true" === a.localStorage.getItem("aplusDebug"), e.aplusDebug = t
                        } catch (r) {}
                        var o = {
                                "aplus_o.js": {
                                    stable_version: {
                        ...
                        var d = f + v + "/alilog",
                            ...
                            w = b.grey_version || {},
                            S = b.dev_version || {},
                            j = c.getArgsQuery("aplusCoreVersion") || c.getMetaCnt("aplus-core-version"),
                            C = j || "1.13.5",
                            E = j || "1.13.8",
                            A = "",
                            L = j || y.value || "8.5.9",
                            ...
                            M = function() {
                                var e = "";
                                if (x && x.length > 0)
                                    for (var t = c.getDateMin(), n = 0; n < x.length; n++) {
                                        var a = x[n].key + "";
                                        t >= a && (e = Math.floor(1e4 * x[n].value))
                                    }
                                return e
                            },
                            B = function(e) {
                                var n, r = t ? [] : g.getFrontPlugins({
                                        version: e,
                                        fn: _,
                                        BU: m,
                                        isDebug: t,
                                    ...
                                    o = p ? [
                                        ["aplus", e, c.isMobile(a.navigator.userAgent) ? "aplus_wap.js" : "aplus_pc.js"].join("/")
                                    ] : [
                                        ["s", e, _].join("/")
                                    ],
                                    i = t ? [] : g.getPlugins({
                                ...
                                try {
                                    var u = [].concat(r, o, i);
                                    n = d + "/??" + u.join(",") + "?v=20240820204623", s = u.length
                                } catch (l) {
                            ...
                            N = M();
                        N && !U && (U = N), e.aplus_cplugin_ver = "0.7.12", e.record || (e.record = function(e, t, n, r) {
                                ...
                                n = function() {
                                    if (!(t >= 100)) {
                                        ...
                                        a.setTimeout(function() {
                                            "complete" === r.status ? c.loopAddScript(d, g.getPlugins({
                                                version: e.lver,
                                                fn: _,
                                                BU: m,
                                                isUseNewAplusJs: p
                ...
                v ? u.addScript(v, function() {}, function() {
                    f()
                }) : f()
            } catch (d) {
                t.console.log("------------ [APLUS LOG] aplus\u52a0\u8f7d\u5668\u5f02\u5e38 ------------"), t.console.log(d)
            }
        }(window)
    }, {
        "../grey/util": 1,
    ...
    6: [function(e, t, n) {
        ...
        var a, r = e("./util"),
            ...
            s = function() {
                for (var e, t, n = [{
                    ...
                    for (var r = n[a].domains, i = n[a].version, s = 0; s < r.length; s++)
                        if (location.href.match(r[s])) return {
                            v: i,
                            BU: n[a].BU
                        };
                return {
        ...
        n.getNewCdnpathByMeta = function() {
            a || (a = r.getMetaCnt("aplus-version"));
            var e = a;
            if (/^\d+$/.test(e)) t = "//d.alicdn.com/alilog/mlog/aplus/" + e + ".js";
            else {
                var t, n = e.split("@");
        ...
        var l = function() {
                try {
                    for (var e = document, t = e.getElementsByTagName("script"), n = 0; n < t.length; n++) {
                        ...
                        if (/alilog\/mlog\/aplus_\w+\.js/.test(a) || /alicdn\.com\/js\/aplus_\w+\.js/.test(a)) return a
                    }
                    return ""
                } catch (r) {
                    return ""
    ...
    7: [function(e, t, n) {
        ...
        function l() {
            return !!f.getMetaCnt("aplus-vt-cfg") || !!f.getMetaCnt("aplus-vt-cfg-url")
        }
        ...
        n.getFrontPlugins = function(e) {
            ...
            return [{
                ...
                enable: !t && !!f,
                path: t ? [c, "aplus4native.js"].join("/") : ["aplus_cplugin", p, f].join("/")
            }, {
                enable: l(),
            ...
            return [{
                enable: t && c(),
                path: [a, "aplus_apm_trace.js"].join("/")
            }, {
                enable: m(e),
                path: "aplus_plugin_guide/index.js"
            }, {
                enable: b(e),
                path: [a, "aplus_spmact.js"].join("/")
            }]
        }
    }, {
        "./util": 8
            ...
            s = function(e) {
                ...
                if (e)
                    for (var n = 0; n < e.length; n++) {
                        var a = e[n].enable,
                            r = e[n].path;
                        a === !0 ? t.push(r) : "function" == typeof a && a() && t.push(r)
                    }
                return t
            };
        n.getPlugins = function(e) {
